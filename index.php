...
<?php include "includes/header.php"; ?>
    ...
    $post_query_count = "SELECT * FROM posts WHERE post_status = 'publish'";
            ...
            $query = "SELECT * FROM posts LIMIT $page_1,  $per_page"; // we write this $query because we need to sellect data from this data base. in this case posts are the db we need
